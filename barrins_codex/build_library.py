# Code by clayadavis/card_codex
# https://github.com/clayadavis/card_codex
...
if __name__ == "__main__":
	...
	cards = json.load(gzip.open("AtomicCards.json.gz"))
